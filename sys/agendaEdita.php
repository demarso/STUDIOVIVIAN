...
<html lang="pt-br">
  ...
  <div class="container">
    <?php
       $id = $_GET['id'];
       include "conexao.php";
       $sql = "SELECT *, DATE_FORMAT(DataServico,'%d/%m/%Y') AS dat,  DATE_FORMAT(Datacad,'%d/%m/%Y') AS dac FROM tblAgenda WHERE idAgenda = '$id'";
    ...
    <form name="form1" method="post" action="agendaEditaOK.php" >
      <input type="text" class="form-control" name="id" id="id" tabindex="-1" value="<?php echo $id; ?>" hidden>
      <!-- ********************************************************************************************************************** -->          
      ...
      <!-- ********************************************************************************************************************** -->          
          <div class="form-group row mt-2 mb-1">
            ...
            <div class="col-md-3">
              <input type="date" class="form-control" name="dataservico" id="dataservico" tabindex="-1" value="<?php echo date('Y-m-d',strtotime($dataservico));?>">
            </div>
          </div>
      <!-- ********************************************************************************************************************** -->          
          <div class="form-group row mt-2 mb-1">
            ...
            <div class="col-md-6">
              <input type="time" id="horaservico" name="horaservico" min="8:00" max="21:00" required="true" pattern="[0-9]{2}:[0-9]{2}" value="<?php echo $horainicio; ?>">&nbsp;&nbsp;&nbsp;Escolha um horário entre 8:00 e 21:00
            </div>
