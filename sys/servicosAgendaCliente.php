...
<html lang="pt-br">
  ...
  <div class="container">
    ...
    <form name="form1" method="post" action="servicosAgendaCadOK2.php" > <!--servicosAgendaCadOK.php -->
      <!-- ********************************************************************************************* -->    
      ...
      <!-- ***************************************************************************************** --> 
          <div class="form-group row mt-1 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="observacoes">Nome:</label>
            <div class="col-md-6">
              <input type="text" class="form-control" name="cliente" id="cliente" tabindex="14" placeholder="Digite seu nome completo">
            </div>
          </div> 
      <!-- *********************************************************************************************** -->
          <div class="form-group row mt-1 mb-1">
      ...
      <!-- *********************************************************************************************** -->
          <div class="form-group row mt-2 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="dataservico">Data do Serviço:</label>
            <div class="col-md-3">
      ...
      <!-- **********************************************************************************************-->          
         <div class="form-group row mt-1 mb-1">
              ...
              <label class="col-sm-2 col-form-label text-success" for="servico">Serviço:</label>
              <div class="col-md-6">
                <select class="form-control" name="servico" id="servico" tabindex="1"  onselect="ajaxGet('servicoConsulta.php?nome='+this.value,document.getElementById('duracao'),true);" required="true">
                 <option value="">---</option>
                  <?php
                    include ("conexao.php");
                ...
                <!--
                  <label class="col-sm-2 col-form-label text-success" for="duracao">Duração:</label>
                
                  <input type="time" class="form-control" name="duracao" id="duracao" size="5" readonly="true"> -->
              </div>  
          ...
          <div class="form-group row mt-1 mb-1">
		    ...
		    <!-- ******************************************************************************************** -->
          <div class="form-group row mt-1 mb-1">
		        <input type="submit" size="150" value="REGISTRAR" onsubmit="checarhora();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
