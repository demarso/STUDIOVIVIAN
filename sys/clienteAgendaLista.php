...
?>
   <div class="container"><br />
      <center><h1 class="text-warning">LISTA DA AGENDA</h1></center>
  <h2 class="text-info">Agendadas de <? echo date('d/m/Y',strtotime($data1))." a ".date('d/m/Y',strtotime($data2)) ?></h2>
<table id="tabela" align="center" width="100%" border="1">
   <thead>
      <tr align="center" bgcolor="#CCCCCC">
        ...
        <th align="center" style="width: 10%"><font color="#333333" size="2"><b>Data do Serviço</b></font></th>
        <th align="center" style="width: 10%"><font color="#333333" size="2"><b>Hora do Serviço</b></font></th>
    ...
    <tr align="center" bgcolor="#CCCCCC">
      ...
      <th align="center" style="width: 10%"><input type="text" id="txtColuna3" size="8%"/></th>
      <th align="center" style="width: 25%"><input type="text" id="txtColuna4" size="20%"/></th>
    ...
    <?php
        ...
        $today = date("d/m/Y");
        $con = 1; $soma = 0;
        $sql = "SELECT *, DATE_FORMAT(DataServico,'%d/%m/%Y') AS dat, DATE_FORMAT(HoraInicio,'%H:%i') AS hor FROM tblAgenda WHERE DataServico >= '$data1' and DataServico <='$data2'ORDER BY DataServico asc";
        $resultado = mysqli_query($conn,$sql) or die (mysql_error());
        while ($linha = mysqli_fetch_array($resultado)) {
    
            $id = $linha['idAgenda'];
            $cliente = $linha['Cliente'];
            $dataservico = $linha['dat'];
            $horaservico = $linha['hor'];
     ...
     <tbody>
      <tr align="center" <? echo $bgcolor; ?>>
        <td align="center" style="width: 10%">
           <?
           echo "<a href=\"javascript:checar1('agendaEdita.php?id=".$id."');\"><img src=\"images/letra-e.png\" width=\"20\" border=\"0\" alt=\"Click para editar a Pessoa.\" title=\"Click para editar a Pessoa.\"></a>&nbsp;&nbsp;&nbsp;&nbsp;";
           ...
           if ($status == 0){
            echo "<a href=\"javascript:checar3('agendaOk.php?id=".$id."');\"><img src=\"images/tick_verde.png\" width=\"20\" border=\"0\" alt=\"Click para deletar a Pessoa.\" title=\"Click para serviço executado.\"></a>";
           }
           if($status == 1){
            echo "<a href=\"javascript:checar3a('agendaDesOk.php?id=".$id."');\"><img src=\"images/tick_vermelho.png\" width=\"20\" border=\"0\" alt=\"Click para deletar a Pessoa.\" title=\"Click para serviço executado.\"></a>";
           }
           ?>
        </td>
        <td align="center" style="width: 8%" ><font <? echo $txcolor; ?> size="2"><b><? echo $con; ?></b></font></td>
        <td align="center" style="width: 10%"><font <? echo $txcolor; ?> size="2"><b><? echo $dataservico; ?></b></font></td>
        <td align="center" style="width: 10%"><font <? echo $txcolor; ?> size="2"><b><? echo $horaservico; ?></b></font></td>
        <td align="center" style="width: 25%"><font <? echo $txcolor; ?> size="2"><b><? echo $cliente; ?></b></font></td>
        <td align="center" style="width: 25%"><font <? echo $txcolor; ?> size="2"><b><? echo $servico; ?></b></font></td>
        <td align="center" style="width: 10%"><font <? echo $txcolor; ?> size="2"><b><? echo $status2; ?></b></font></td>
      </tr>
     </tbody>
      </table>
    </center>
