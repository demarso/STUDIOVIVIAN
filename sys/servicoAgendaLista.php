...
<table id="tabela" align="center" width="100%" border="1">
   <thead>
    ...
    <?php
        ...
        $today = date("d/m/Y");
        $con = 1; $soma = 0;
        $sql = "SELECT *, DATE_FORMAT(DataServico,'%d/%m/%Y') AS dat FROM tblAgenda WHERE DataServico >= '$data1' and DataServico <='$data2'ORDER BY DataServico asc";
