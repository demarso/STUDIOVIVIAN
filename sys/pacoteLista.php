...
<table id="tabela" align="center" width="100%" border="1">
   <thead>
      <tr align="center" bgcolor="#CCCCCC">
        ...
        <th align="center" style="width: 30%"><font color="#333333" size="2"><b>Pacote</b></font></th>
        <th align="center" style="width: 30%"><font color="#333333" size="2"><b>Serviço</b></font></th>
        <th align="center" style="width: 10%"><font color="#333333" size="2"><b>Quantidade</b></font></th>
        <th align="center" style="width: 10%"><font color="#333333" size="2"><b>Status</b></font></th>
              
    <tr align="center" bgcolor="#CCCCCC">
      <th align="center" style="width: 10%"></th>
      <th align="center" style="width: 10%"></th>
      <th align="center" style="width: 30%"><input type="text" id="txtColuna3" size="20%"/></th>
      <th align="center" style="width: 30%"><input type="text" id="txtColuna4" size="20%"/></th>
      <th align="center" style="width: 10%"><input type="text" id="txtColuna5" size="5%"/></th>
    ...
    <?php
        ...
        $today = date("d/m/Y");
        $con = 1; $soma = 0;
        $sql = "SELECT * FROM tblPacotes ORDER BY Pacote asc";
     ...
     <tbody>
      <tr align="center" <? echo $bgcolor; ?>>
        <td align="center" style="width: 10%">
           <?
           echo "<a href=\"javascript:checar1('pacoteEdita.php?id=".$id."');\"><img src=\"images/letra-e.png\" width=\"20\" border=\"0\" alt=\"Click para editar a Pessoa.\" title=\"Click para editar a Pessoa.\"></a>&nbsp;&nbsp;&nbsp;&nbsp;";
           echo "<a href=\"javascript:checar2('pacoteDeleta.php?id=".$id."');\"><img src=\"images/letra-d.png\" width=\"20\" border=\"0\" alt=\"Click para deletar a Pessoa.\" title=\"Click para deletar a Pessoa.\"></a>";
           ?>
        </td>
        <td align="center" style="width: 10%" ><font <? echo $txcolor; ?> size="2"><b><? echo $con; ?></b></font></td>
        <td align="center" style="width: 30%"><font <? echo $txcolor; ?> size="2"><b><? echo $pacote; ?></b></font></td>
        <td align="center" style="width: 30%"><font <? echo $txcolor; ?> size="2"><b><? echo $servico; ?></b></font></td>
         <td align="center" style="width: 10%"><font <? echo $txcolor; ?> size="2"><b><? echo $quantidade; ?></b></font></td>
