...
<html lang="pt-br">
  ...
  <div class="container">
    ...
    <form name="form1" method="post" action="servicosAgendaCadOK.php" >
      ...
      **********************************************************************************************************************        
          <div class="form-group row mt-2 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="horaservicoA">Hora do Serviço:</label>
            <div class="col-md-3">
              <input type="time" id="horaservico" name="horaservico" min="08:00" max="22:00">
            </div>
          </div>    
     **********************************************************************************************************************            
