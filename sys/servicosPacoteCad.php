...
<html lang="pt-br">
  ...
  <div class="container">
    ...
    <form name="form1" method="post" action="servicosPacoteCadOK.php" >
      <!-- ********************************************************************************************************************** -->          
      ...
      <!-- ********************************************************************************************************************** -->           
        <div class="form-group row mt-1 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="nome">Serviço 1:</label>
            <div class="col-md-4">
              <select class="form-control" name="servico1" id="servico1" tabindex="1" required="true">
               <option value="">---</option>
                <?php
                  include ("conexao.php");
            ...
            <label class="col-sm-2 col-form-label text-success" for="qtdServico">Quantidade:</label>
            <div class="col-md-2">
              <input type="text" class="form-control" name="qtdServico1" id="qtdServico1" tabindex="-1">
            </div>
          </div>
        <!-- ********************************************************************************************************************** -->           
        <div class="form-group row mt-1 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="nome">Serviço 2:</label>
            <div class="col-md-4">
              <select class="form-control" name="servico2" id="servico2" tabindex="1" required="true">
               <option value="">---</option>
                <?php
                  include ("conexao.php");
                  $sql = "SELECT Servico FROM tblServicos WHERE Status=1 ORDER BY Servico";
            ...
            <label class="col-sm-2 col-form-label text-success" for="qtdServico">Quantidade:</label>
            <div class="col-md-2">
              <input type="text" class="form-control" name="qtdServico2" id="qtdServico2" tabindex="-1">
            </div>
          </div>
          <!-- ********************************************************************************************************************** -->           
        <div class="form-group row mt-1 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="nome">Serviço 3:</label>
            <div class="col-md-4">
              <select class="form-control" name="servico3" id="servico3" tabindex="1" required="true">
               <option value="">---</option>
                <?php
                  include ("conexao.php");
                  $sql = "SELECT Servico FROM tblServicos WHERE Status=1 ORDER BY Servico";
            ...
            <label class="col-sm-2 col-form-label text-success" for="qtdServico">Quantidade:</label>
            <div class="col-md-2">
              <input type="text" class="form-control" name="qtdServico3" id="qtdServico3" tabindex="-1">
            </div>
          </div>
          <!-- ********************************************************************************************************************** -->           
        <div class="form-group row mt-1 mb-1">
            <label class="col-sm-2 col-form-label text-success" for="nome">Serviço 4:</label>
            <div class="col-md-4">
              <select class="form-control" name="servico4" id="servico4" tabindex="1" required="true">
               <option value="">---</option>
                <?php
                  include ("conexao.php");
                  $sql = "SELECT Servico FROM tblServicos WHERE Status=1 ORDER BY Servico";
            ...
            <label class="col-sm-2 col-form-label text-success" for="qtdServico">Quantidade:</label>
            <div class="col-md-2">
              <input type="text" class="form-control" name="qtdServico4" id="qtdServico4" tabindex="-1">
            </div>
          </div>
        <!-- ********************************************************************************************************************** -->
          <div class="form-group row mt-1 mb-1">
