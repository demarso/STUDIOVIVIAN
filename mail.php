...
# be able to control score result conditions, so I included that in this example.
  ...
  if ($res['success'] == true && $res['score'] >= 0.5) {
    ...
    # Recipient email
    $mail_to = "vivian.vms@hotmail.com";
    ...
    if ($success) {
      ...
      echo '<p class="alert alert-success">Obrigado! Sua mensagem foi enviada com sucesso.</p>';
    } else {
      # Set a 500 (internal server error) response code
      http_response_code(500);
      echo '<p class="alert alert-warning">Algo deu errado. Tente Novamente!</p>';
    }   

  } else {

    echo '<div class="alert alert-danger">
        Erro! O token de segurança expirou ou você é um Robot.
       </div>';
  }  
  ...
  echo '<p class="alert-warning">Ocorreu um problema com seu envio, tente novamente.</p>';
} 
